...
In order to setup our minimal [_Kernel_](https://en.wikipedia.org/wiki/Kernel_(operating_system)) we carried certain workaround, in the next few steps we have explained them.
